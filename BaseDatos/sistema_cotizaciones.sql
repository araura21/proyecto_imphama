...
--
-- Servidor: localhost
-- Tiempo de generación: 12-08-2025 a las 00:08:47
...
INSERT INTO `producto` (`idProducto`, `nombre`, `descripcion`, `estado`, `creado_at`) VALUES
(1, 'Laptop Gamer XYZ', 'Laptop con procesador i7, 16GB RAM, SSD 512GB', 'activo', '2025-08-10 00:31:25'),
(2, 'Monitor 24\" FullHD', 'Monitor LED de 24 pulgadas con resolución FullHD', 'activo', '2025-08-10 00:31:25'),
(3, 'Teclado Mecánico RGB', 'Teclado con switches mecánicos y retroiluminación RGB', 'activo', '2025-08-10 00:31:25');
...
INSERT INTO `proveedor` (`idProveedor`, `ruc`, `nombre_empresa`, `telefono`, `correo`, `direccion`, `creado_at`, `estado`) VALUES
(1, '1234567890001', 'Proveedor Uno S.A.', '0991111111', 'contacto@proveedor1.com', 'Av. Principal 123', '2025-08-10 00:31:25', 'activo'),
(2, '2234567890002', 'Proveedor Dos Ltda.', '0992222222', 'contacto@proveedor2.com', 'Calle Secundaria 45', '2025-08-10 00:31:25', 'activo'),
(3, '3234567890003', 'Proveedor Tres', '0993333333', 'ventas@proveedortres.com', 'Av. Central 789', '2025-08-10 00:31:25', 'activo'),
(4, '4234567890004', 'Proveedor Cuatro', '0994444444', 'info@proveedor4.com', 'Calle 10 #20-30', '2025-08-10 00:31:25', 'activo'),
(5, '5234567890005', 'Proveedor Cinco', '0995555555', 'ventas@proveedor5.com', 'Av. Las Flores 100', '2025-08-10 00:31:25', 'activo'),
(6, '6234567890006', 'Proveedor Seis', '0996666666', 'contacto@proveedor6.com', 'Calle Los Pinos 77', '2025-08-10 00:31:25', 'activo');
...
--
ALTER TABLE `empleado`
  MODIFY `idEmpleado` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `rol`
  MODIFY `idRol` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
