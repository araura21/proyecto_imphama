...
<head>
  ...
  <title>Panel Bodeguero - IMPHAMA</title>
...
<body>
  <div class="admin-wrapper" style="display:flex; min-height:100vh;">
    <aside class="sidebar">
      ...
      <div class="desc">Panel de bodeguero<br>Bienvenido Bodeguero</div>
      <nav class="nav">
        <button class="nav-item active"><i class="fas fa-boxes-stacked"></i> Productos</button>
      </nav>
    </aside>
